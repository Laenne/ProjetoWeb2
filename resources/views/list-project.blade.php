...
<html lang="en">
  ...
  <div id="mySidenav" class="sidenav">
    <a href="/home" style="text-decoration: none" > 
        <h4> <i class="fa fa-archive"></i> <span id="underline">Projetos</span></h4> 
    </a>    
    
    <a href="/myProjects" style="text-decoration: none"> 
        <h4> <i class="fa fa-folder"></i> <span id="underline">Meus projetos</span></h4> 
    </a>
                    ...
                    <div class="col-md-12">   
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead style="background-color: black; color: white; font-size: large ; ">
                                    <tr>
                                ...
                                <tbody style="font-size: medium;">
                                    ...
                                    <tr id="testeProjetos{{$project->id}}" >
                                        ...
                                        <td id="center">
                                            ...
                                            &nbsp;
                                            @if($project->finalizado == 1)
                                            <a title="Apoiar" id="apoiar_p{{$project->id}}" onclick="alert('Projeto finalizado, não é possivel apoiar.')" style="">
                                            ...
                                            <a title="Apoiar" id="apoiar_p{{$project->id}}" data-toggle="modal" data-target="#modalApoiador_p{{$project->id}}">
                                                <i class="fa fa-thumbs-up" style="color: #33cc33" ></i>
                                            </a>
                                            @endif
                                        </td>
                                    </tr>
